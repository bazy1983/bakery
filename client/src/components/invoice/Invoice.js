        ...
        return (
            <div>
                ...
                <div>
                    ...
                    {/* disable print button if no invoiceid generated by selecting a business */}
                ...
                <table className="centered">
                    ...
                    <tbody>
                                ...
                                this.state.records.map((record) => {
                                    return (
                                        <tr key={record.id}>
                                            ...
                                            <td>{record.total}</td>
                                            <td><MdLayersClear style={{ transform: "scale(1.2)" }}  onClick={this.removeRecord.bind(this, record.id)}/></td>
                                        </tr>
                                    )
                                })
                                :
                        ...
                        <tr className={this.state.invoiceId?null:"disabled"}>{/* start new record fields */}
                            <td>{counter++}</td>
                            <td>
                                {/* Product Dropdown */}
                            ...
                            <td className="blue-text">
                                <MdLibraryAdd onClick={this.newRecordSubmit} style={{ transform: "scale(1.2)"}} />
                            </td>
                        </tr>
                    </tbody>
                </table>
